...
* **[全体設計書 (`docs/architecture.md`)](docs/architecture.md) [github pages版architecture.md](https://sayt25606-rgb.github.io/sakai-tasks-mcp/)**:
...
2. **Issue からブランチを作成**:
   ...
   * branch名は次のように決めます。issueタイトルが
   ...
   feat/1-src-server
3. **仕様の確認 & 実装**:
   * `docs/architecture.md`[github pages版architecture.md](https://sayt25606-rgb.github.io/sakai-tasks-mcp/) の **第 1〜3 章**（全体像・共通モデル）と **自分の担当ファイルのセクション** を確認し、コードを実装します。
